       ...
       // private MonoScript script;
        ...
        private void ShowDebug()
        {
           ...
           //var DebColor = (GUI.color * 0.8f) + (Color.yellow * 0.2f);
            ...
            if (Application.isPlaying)
            {
                ...
                //EditorGUILayout.FloatField("AlignPosLerpDelta", m.AlignPosLerpDelta);
                EditorGUILayout.Space();
        ...
        private void ShowStates()
        {
            ...
            if (showStates.boolValue)
            {
                ...
                {
                    var element = Reo_List_States.serializedProperty.GetArrayElementAtIndex(Reo_List_States.index);
        ...
        private void OnAddCallback_State(ReorderableList list)
        {
            ...
            for (int i = 0; i < StatesType.Count; i++)
            {
                ...
                if (!founded)
                {
                    ...
                    addMenu.AddItem(new GUIContent(name), false, () => AddState(st,name));
                }
            }
