...
namespace MalbersAnimations
{
    ...
    public class MobileJoystickEditor : Editor
    {
        ...
        SerializedProperty /*CameraInput,*/ invertX, invertY, sensitivityX, sensitivityY, axisValue, OnJoystickDown, OnJoystickUp, Relative,
        ...
        private void OnEnable()
        {
           ...
           // CameraInput = serializedObject.FindProperty("CameraInput");
            ...
            Relative = serializedObject.FindProperty("m_Drag");
