...
namespace MalbersAnimations.HAP
{
    ...
    public class MRider : MonoBehaviour, IAnimatorListener, IRider
    {
       ...
       // public OverrideCapsuleCollider ModifyMainCollider;
        ...
        //    {
        //        isOnHorse = value;
        //        Debug.Log("Is On Horse" + isOnHorse);                         //Update Mount Parameter on the Animator
        //    }
        //}
...
/// <summary> Speed Multiplier for the Speeds Changes while using other Animals</summary>
        ...
        void Start()
        {
            ...
            if (Anim)
            {
                ...
                if (MountLayerIndex != -1)Anim.SetLayerWeight(MountLayerIndex, 1); //Just in case
        ...
        {
            if (MountStored && m_MountStored.Value.activeSelf)
            {
        ...
        internal virtual void Start_Mounting()
        {
            ...
            m_MountStored.Value = Montura.gameObject;       //Store the last animal you mounted
    ...
    //    private MonoScript script;
        protected SerializedProperty MountStored, StartMounted, Parent, animator, m_rigidBody, m_root, gravity, ReSync,
        ...
        /*  CreateColliderMounted,   Col_Center, Col_height, Col_radius, Col_Trigger,*/ CallAnimalA, StopAnimalA, RiderAudio, LeftHand, RightHand, MountCollider,
