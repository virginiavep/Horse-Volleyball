...
namespace MalbersAnimations.Controller
{
    public partial class MAnimal
    {
        ...
        void OnAnimatorMove()
        {
            ...
            if (IsPlayingMode) ActiveMode.CheckActiveMode(); //FOR MODES  Still need to work this better yeah I know (IS WHEN THE INPUT IS PRESSED ON A MODE
        ...
        {
            var Acel = ExternalForceAcel > 0 ? (DeltaTime * ExternalForceAcel) : 1; //Use Full or 
