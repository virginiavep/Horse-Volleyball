    ...
    public partial class MAnimal
    {
        ...
        public int Stance
        {
            ...
            set
            {
                ...
                SetOptionalAnimParameter(hash_Stance, currentStance); //Set on the Animator the Current Stance
               ...
               // Debug.Log("Stance: "+ currentStance);
            }
        }
        #endregion
        ...
        public bool Sprint
        {
            ...
            set
            {
                var realSprint = UseSprintState && value && UseSprint && MovementDetected; //Check if the animal has movement
       ...
       [SerializeField] private BoolReference grounded = new BoolReference(false);
        ...
        public Mode ActiveMode
        {
            ...
            internal set
            {
                ...
                LastMode = (lastMode != null && lastMode.ID != null) ? lastMode.ID : 0; 
