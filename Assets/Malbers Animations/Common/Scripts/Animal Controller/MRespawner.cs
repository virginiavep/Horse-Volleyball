...
namespace MalbersAnimations.Controller
{
    ...
    public class MRespawner : MonoBehaviour
    {
        ...
        public TransformReference RespawnPoint;
        ...
        private void Reset()
        {
            if (RespawnPoint == null || RespawnPoint.Value == null) SetDefaultRespawnPoint();
        }
        ...
        void Start()
        {
            ...
            if (player == null) Destroy(gameObject); //Destroy This GO since is already a Spawner in the scene
        }
